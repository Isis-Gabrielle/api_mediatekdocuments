...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : jeu. 19 fév. 2026 à 19:36
...
('0001', '2026-02-13', '10002'),
('0005', '2026-02-20', '10002');
...
--
DROP TRIGGER IF EXISTS `commande_delete`;
DELIMITER $$
CREATE TRIGGER `commande_delete` BEFORE DELETE ON `commande` FOR EACH ROW BEGIN
...
--
DROP TRIGGER IF EXISTS `commande_insert_exemplaire`;
DELIMITER $$
CREATE TRIGGER `commande_insert_exemplaire` AFTER UPDATE ON `commandedocument` FOR EACH ROW BEGIN 
    DECLARE i INT DEFAULT 0; 
    DECLARE dernier_num INT DEFAULT 0; 
    DECLARE id_etat_neuf VARCHAR(5) DEFAULT '00001'; 
    DECLARE date_com DATE;

    IF NEW.idSuivi = '00002' AND (OLD.idSuivi IS NULL OR OLD.idSuivi <> '00002') THEN 
...
('00001', 'Quand sort la recluse', '', 'LV003', '00002', '10018'),
...
('10002', 'Alternatives Economiques', 'C:\\Users\\HO OMEN\\Documents\\Images\\Anaxa\\201fb5ba7042dc5f5820e7d2251fd678.jpg', 'PR002', '00002', '10015'),
...
('20003', 'Jurassic Park', 'C:\\Users\\HO OMEN\\Documents\\Images\\Anaxa\\70b0a4afdd4dfa54ff6e14a4624e42e1.jpg', 'DF001', '00003', '10002'),
...
('00017', 2, '2026-02-08', '', '00003'),
('00017', 5, '2026-02-08', '', '00004'),
...
('20003', 2, '2026-02-08', '', '00001'),
('20003', 3, '2026-02-08', '', '00001'),
('20003', 4, '2026-02-08', '', '00001'),
('20003', 5, '2026-02-08', '', '00001');
...
INSERT INTO `utilisateur` (`id`, `email`, `password`, `idservice`) VALUES
('00001', 'admin@test.com', '$2a$12$UXpS3hJ/4px8DJkARTop3eZw6HgmQhPmVrYS0l0V2luWgH4e10nwa', '00001'),
('00002', 'prets@test.com', '$2a$12$UXpS3hJ/4px8DJkARTop3eZw6HgmQhPmVrYS0l0V2luWgH4e10nwa', '00002'),
('00003', 'culture@test.com', '$2a$12$UXpS3hJ/4px8DJkARTop3eZw6HgmQhPmVrYS0l0V2luWgH4e10nwa', '00003');
